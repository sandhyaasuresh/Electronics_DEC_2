	...
	public static InventoryService getInventoryService() {
		try {
	         return (InventoryService) InitialContext.doLookup(
	        		 "java:global/Electronics_Team_12_InventoryManagement_EJBEAR/Electronics_Team_12_InventoryManagement_EJB/InventoryServiceBean!edu.osu.cse5234.business.view.InventoryService");
		} catch (NamingException ne) {
				throw new RuntimeException(ne);
		}
	}
